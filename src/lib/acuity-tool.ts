import { AcuityFormTemplate, CompetencyLevel } from '@/types';

export interface AcuityTierInfo {
  tier: 1 | 2 | 3;
  tierRoman: 'Acuity I' | 'Acuity II' | 'Acuity III';
  tierLabel: string;
  minScore: number;
  maxScore: number;
  npRatio: string;
  npRatioNumber: number; // e.g. 6 for 1:6
  staffingRequirement: string;
  allowedCompetencies: CompetencyLevel[];
  color: string;
  bgLight: string;
  borderColor: string;
}

export const SIMS_ACUITY_SCALE: Record<1 | 2 | 3, AcuityTierInfo> = {
  1: {
    tier: 1,
    tierRoman: 'Acuity I',
    tierLabel: 'Acuity 1 (Minimal Assistance / Low Risk)',
    minScore: 1,
    maxScore: 12,
    npRatio: '1:6',
    npRatioNumber: 6,
    staffingRequirement: 'Novice and Limited level staff shall get patients with acuity score 1 & 2',
    allowedCompetencies: ['Novice', 'Advanced Beginner', 'Competent', 'Proficient', 'Expert'],
    color: '#059669',
    bgLight: '#ecfdf5',
    borderColor: '#a7f3d0'
  },
  2: {
    tier: 2,
    tierRoman: 'Acuity II',
    tierLabel: 'Acuity 2 (Moderate Assistance / 2h Vitals)',
    minScore: 13,
    maxScore: 24,
    npRatio: '1:5',
    npRatioNumber: 5,
  ...
  3: {
    tier: 3,
    tierRoman: 'Acuity III',
    tierLabel: 'Acuity 3 (Complete Assistance / Continuous Monitoring)',
    minScore: 25,
    maxScore: 48,
    npRatio: '1:4',
    npRatioNumber: 4,
    staffingRequirement: 'Patient with acuity score of 3 shall be given to competent / proficient or expert categories of staff',
    allowedCompetencies: ['Competent', 'Proficient', 'Expert'],
    color: '#dc2626',
    bgLight: '#fef2f2',
    borderColor: '#fecaca'
  }
...
export function interpretAcuityScore(score: number): AcuityTierInfo {
  if (score >= 25) return SIMS_ACUITY_SCALE[3];
  if (score >= 13) return SIMS_ACUITY_SCALE[2];
  return SIMS_ACUITY_SCALE[1];
}

export function isStaffCompetentForAcuity(nurseCompetency: CompetencyLevel, patientAcuityTier: 1 | 2 | 3): boolean {
  const allowed = SIMS_ACUITY_SCALE[patientAcuityTier].allowedCompetencies;
  return allowed.includes(nurseCompetency);
}

// Master SIMS Patient Acuity Tool Description Template (from Hospital Standard PDF)
export const simsPatientAcuityTemplate: AcuityFormTemplate = {
  ...
  fields: [
    ...
    // 3. Basic Activities
    {
      ...
      options: [
        ...
        { id: 'feed-1', label: 'Oral feed (assisted)', score: 1 },
    ...
    {
      id: 'param-catheter',
      title: 'Incontinence & Catheter Care',
      category: 'Basic Activities',
      options: [
    ...
    {
      id: 'param-oral-trach',
      title: 'Oral & Tracheostomy / Behavior Care',
      category: 'Basic Activities',
      options: [
        { id: 'trach-0', label: 'Self oral hygiene', score: 0 },
        { id: 'trach-1', label: 'Oral care assisted', score: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'mob-3', label: 'High risk pressure ulcers / Total immobility (NA)', score: 3 }
      ]
    },
    {
      id: 'param-tubes',
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'iv-1', label: '1 IV medication or maintenance fluid', score: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'inf-1', label: 'Mild electrolyte supplement', score: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'neb-1', label: 'PRN Inhaler as needed', score: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'spec-1', label: 'Peripheral vitamin infusion', score: 1 },
        { id: 'spec-2', label: 'TPN (Total Parenteral Nutrition)', score: 2 },
    ...
    // 4. Therapeutic interventions
    {
      ...
      title: 'Therapeutic Interventions & Critical Procedures',
    ...
    // 5. Admission /Discharge/Transfer
    {
      ...
      options: [
        ...
        { id: 'adt-3', label: 'Emergency resuscitation transfer / Complex ICU transfer (NA)', score: 3 }
      ]
    },
    ...
    {
      id: 'param-edu',
      title: 'Education, Behavioral & Communication Needs',
